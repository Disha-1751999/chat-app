...
function MessageBar() {
  ...
  const {selectedChatType,selectedChatData,isUploading,isDownloading, fileUploadProgress, fileDownloadProgress,setIsUploading,}=ContactStore()
  const {UserInfo}=AuthStore()
  const {UploadFileRequest}= MessageStore()
